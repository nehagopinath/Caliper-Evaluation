...
module.exports.info = 'Querying a model.';
...
module.exports.run = function() {
    ...
    let args = {
        chaincodeFunction: 'queryModel',
        chaincodeArguments: [modelNumber]
    };
    ...
    return bc.bcObj.querySmartContract(contx, 'model', 'v1', args, 30);
};
